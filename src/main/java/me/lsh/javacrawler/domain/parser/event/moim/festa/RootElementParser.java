...
public class RootElementParser {
    ...
    public LocalDateTime parseStartedAt() throws WebCrawlerParseException {
    ...
    public LocalDateTime parseExpiredAt() throws WebCrawlerParseException {
        String duration = parseDuration().split(DURATION_SPLITTER)[0];
    ...
    public String parseDuration() {
        String duration = elements
            .select(".PrimaryEventInfo__DateInfo-sc-86u3sj-3 div:eq(1)")
            .text();
    ...
    private LocalDateTime parseLocalDateTime(final String dateStr) {
        try {
            ...
            throw new WebCrawlerParseException("Can not parse datetime. " + dateStr,
                this.getClass(), e);
        }
    }

    public String parseOrganizer() {
        String organizer = elements
            .select("div.PrimaryEventInfo__HostText-sc-86u3sj-10")
            .text();
